        ...
        ViewInteraction textView3 = onView(
                allOf(withText("Create Events Page"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textView3.check(matches(withText("Create Events Page")));
        ...
        ViewInteraction textView4 = onView(
                allOf(withText("Home Screen"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textView4.check(matches(withText("Home Screen")));
        ...
        ViewInteraction textView5 = onView(
                allOf(withText("Events Page"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textView5.check(matches(withText("Events Page")));
